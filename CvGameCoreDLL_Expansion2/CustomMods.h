...
#define MOD_BALANCE_CORE_NO_PRESSURE_FROM_POP		(MOD_COMMUNITY_PATCH && gCustomMods.isBALANCE_CORE_NO_PRESSURE_FROM_POP())
...
public:
	...
	MOD_OPT_DECL(BALANCE_CORE_NO_PRESSURE_FROM_POP);
